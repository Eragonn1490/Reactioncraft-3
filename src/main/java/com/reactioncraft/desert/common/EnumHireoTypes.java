...
public enum EnumHireoTypes implements IStringSerializable
{
    ...
    private static final EnumHireoTypes[] META_LOOKUP = new EnumHireoTypes[values().length];
    private static final EnumHireoTypes[] DYE_DMG_LOOKUP = new EnumHireoTypes[values().length];
    ...
    private EnumHireoTypes(int meta, int dyeDamage, String name, String unlocalizedName, MapColor mapColorIn, TextFormatting chatColor)
    {
        this.meta = meta;
    ...
    public static EnumHireoTypes byDyeDamage(int damage)
    {
    ...
    public static EnumHireoTypes byMetadata(int meta)
    {
    ...
    static
    {
        for (EnumHireoTypes enumdyecolor : values())
        {
