...
public class BlockFreezer extends BlockContainer
{
    ...
    public BlockFreezer(boolean isBurning)
    {
        super(Material.ROCK);
    ...
    {
        return Item.getItemFromBlock(IntegratedBlocks.FreezerIdle);
    }
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, @Nullable ItemStack heldItem, EnumFacing side, float hitX, float hitY, float hitZ)
    {
        ...
        else
        {
            ...
            {
                playerIn.displayGUIChest((TileEntityFreezer)tileentity);
    ...
    public static void setState(boolean active, World worldIn, BlockPos pos)
    {
        ...
        if (active)
        {
            worldIn.setBlockState(pos, IntegratedBlocks.FreezerActive.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, IntegratedBlocks.FreezerActive.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
        }
        else
        {
            worldIn.setBlockState(pos, IntegratedBlocks.FreezerIdle.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, IntegratedBlocks.FreezerIdle.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
        }
    ...
    {
        return new ItemStack(IntegratedBlocks.FreezerIdle);
    }
