package com.reactioncraft.machines.common;
...
public class BlockBrickOven extends BlockContainer
{
    ...
    {
        return Item.getItemFromBlock(IntegratedBlocks.BrickOvenIdle);
    }
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, @Nullable ItemStack heldItem, EnumFacing side, float hitX, float hitY, float hitZ)
    {
        ...
        else
        {
            ...
            {
                playerIn.displayGUIChest((TileEntityBrickOven)tileentity);
    ...
    public static void setState(boolean active, World worldIn, BlockPos pos)
    {
        ...
        if (active)
        {
            worldIn.setBlockState(pos, IntegratedBlocks.BrickOvenActive.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, IntegratedBlocks.BrickOvenActive.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
        }
        else
        {
            worldIn.setBlockState(pos, IntegratedBlocks.BrickOvenIdle.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, IntegratedBlocks.BrickOvenIdle.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
        }
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
    {
        ...
        if (stack.hasDisplayName())
        {
            ...
            if (tileentity instanceof TileEntityBrickOven)
            {
                ((TileEntityBrickOven)tileentity).setCustomInventoryName(stack.getDisplayName());
            }
        }
    }
    ...
    {
        return new ItemStack(IntegratedBlocks.BrickOvenIdle);
    }
