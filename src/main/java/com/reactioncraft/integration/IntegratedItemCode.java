...
public class IntegratedItemCode
{
    ...
    **/
    ...
    { 
        ...
        //IntegratedItems.meatcleaver = (new ItemMeatCleaver(IntegratedConfigI.meatcleaverIID, IntegratedMaterials.EnumToolMaterialMeatcleaver)).setUnlocalizedName("reactioncraft:meatcleaver").setTextureName("reactioncraft:meatcleaver").setCreativeTab(reactioncraft.ReactioncraftItems);
        /**
