...
public class IntegratedItems
{
    ...
    public static ItemBase UncutLBGem;
    public static ItemBase CutLBGem;
    ...
    public static ItemBase bloodstoneclump;
    public static ItemBase goldrod;
    public static ItemBase obsidianingot;
    public static ItemBase ingotbloodstone;
    public static ItemBase ingotsilver;
    public static ItemBase bloodstonedust;
    public static ItemBase blackdiamond;
    public static ItemBase dragonstoneshard;
    public static ItemBase irondust;
    public static ItemBase gemdragonstone;
    public static ItemBase superheatedironingot;
    public static ItemBase goldDust;
    public static ItemBase moltenglass;
    ...
    public static ItemBase Bloodstonebore;
    
    //Ores
    public static ItemBase meltedventinite;
    public static ItemBase meltedwizimite;
    
    
    //Currency Items
    public static ItemBase Bag;
    public static ItemBase Sack;
    public static ItemBase Straw;
    public static ItemBase CoinMould;
    public static ItemBase moltengold;
    public static ItemBase moltensilver;
    public static ItemBase moltencopper;
    public static ItemBase moltenbronze;
    public static ItemBase copperbucket;
    public static ItemBase silverbucket;
    public static ItemBase bronzebucket;
    public static ItemBase goldbucket;
    public static ItemBase ingotRefinedgold;
    public static ItemBase ingotSilver;
    public static ItemBase ingotBronze;
    public static ItemBase ingotCopper;
    public static ItemBase ingotmould;
    public static ItemBase ruby;
    public static ItemBase Metadatacoin;
    
    //Armor Items
    public static ItemBase Crown;
    public static ItemBase KinglyChest;
    public static ItemBase KinglyLegs;
    public static ItemBase KinglyBoots;
    public static ItemBase emeraldcrown;
    public static ItemBase diamondcrown;
    public static ItemBase rubycrown;
    public static ItemBase bloodstonehelm;
    public static ItemBase bloodstonechest;
    public static ItemBase bloodstonelegs;
